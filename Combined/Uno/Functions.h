...
// Below is for uno
    ...
    if (readString.startsWith("$"))
    {
      ...
      else
      {
        if (readString.startsWith("$0"))
         {
          Serial.println(F("Reset EEPROM except odo"));
          ...
          if (pos > 0)
          {
            ...
            switch (command)
            {
              case 100:
                ...
                {
                  Serial.print(F("Set $100="));
                  Serial.println(parameter);

                  EEPROM.writeLong(eepromSpeedoCalibrateAddress, parameter.toInt());
                }
                break;
              case 102:
                if (parameter == "")
                ...
                {
                  Serial.print(F("Set $102="));
                  Serial.println(parameter);
                  EEPROM.writeLong(eepromTrip1Address, parameter.toInt());
                }
                break;
              case 103:
                if (parameter == "")
                ...
                {
                  Serial.print(F("Set $103="));
                  Serial.println(parameter);
                  EEPROM.writeLong(eepromTrip2Address, parameter.toInt());
                }
                break;
              ...
              case 200:
                ...
                {
                  Serial.print(F("Set $200="));
                  Serial.println(parameter);
                  EEPROM.writeByte(eepromTachoPPRAddress, parameter.toInt());
                }
                break;
              case 201:
                if (parameter == "")
                ...
                {
                  Serial.print(F("Set $201="));
                  Serial.println(parameter);
                  EEPROM.writeByte(eepromTachoTypeAddress, parameter.toInt());
                }
                break;
              ...
              case 202:
                ...
                {
                  Serial.print(F("Set $202="));
                  Serial.println(parameter);
                  EEPROM.writeInt(eepromTachoRedlineAddress, parameter.toInt());
                }
                break;
              ...
              case 203:
                ...
                {
                  Serial.print(F("Set $203="));
                  Serial.println(parameter);
                  EEPROM.writeInt(eepromTachoShiftAddress, parameter.toInt());
                }
                break;
              ...
              case 204:
                ...
                {
                  Serial.print(F("Set $204="));
                  Serial.println(parameter);
                  EEPROM.writeInt(eepromTachoMaximumAddress, parameter.toInt());
                }
                break;
              ...
              case 205:
                ...
                {
                  Serial.print(F("Set $205="));
                  Serial.println(parameter);
                  EEPROM.writeInt(eepromTachoCalibrateAddress, parameter.toInt());
                }
                break;
              ...
              case 999:
                if ((parameter == "") || (parameter.length() < 5))
                {
                  Serial.println(F("Value and passcode required"));
                }
                else
                {
                  String odo = parameter.substring(0, parameter.length() - 4);
